...
<template>
  <section id="about" class="flex items-center justify-center flex-col w-full pt-72
  bg-gradient-to-b from-[#E8EDFA] via-[#E8EDFA] to-[#fff]
  ">
    <h2  class="text-4xl text-gray-600" data-aos="fade">Best tool for your plants</h2>
